...
subtitle: "**Statistical Consideration and Analysis Results**"
...
packages <- c("here", "conflicted", 
              ...
              "gtsummary", "gt", "gtreg", "BiocManager", "htmltools",
...
#| echo: false
## Load datasets
load(file=here("../../data_management/data/adam/dt_psychometric.RData"))
load(file=here("../../data_management/data/adam/dt_disposition.RData"))
load(file=here("../../data_management/data/adam/dt_concordance.RData"))
load(file=here("../../data_management/data/adam/dt_to_score.RData"))
```
